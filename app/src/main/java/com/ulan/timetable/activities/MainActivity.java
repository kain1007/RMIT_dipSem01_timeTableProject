    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.schoolwebsitemenu:
                String schoolWebsite = PreferenceManager.getDefaultSharedPreferences(this).getString(SettingsActivity.KEY_SCHOOL_WEBSITE_SETTING, "www.facebook.com");
            ...
            case R.id.events:
                ...
                return true;
            case R.id.contacts:
                Intent contact = new Intent(MainActivity.this, ContactsActivity.class);
                startActivity(contact);
                return true;
            case R.id.tasks:
                Intent task = new Intent(MainActivity.this, TasksActivity.class);
                startActivity(task);
                return true;
            case R.id.notes:
